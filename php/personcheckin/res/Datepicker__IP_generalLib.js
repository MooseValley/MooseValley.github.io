...
// REF: https://stackoverflow.com/questions/4332379/simple-datepicker-like-calendar
// http://services.iperfect.net/js/IP_generalLib.js
...
function IP_gridReadWrite(IP_grid_config,IP_grid_arr,IP_jsonObj,divID){
    ...
    for( var data in IP_grid_arr[0]) {
                            ...
                            IP_html += "<td id='"+IP_fieldname+"_"+primary_key_value+"_"+getUID+"' "+link_cell_function+">" + eval("IP_jsonObj[j]." + IP_fieldname) + "</td>";
                            }catch(err){
