...
$db->queryResultsToHTMLTable ("Most Recently Added records:", true, true, false, false);
...
<form name="show-apartment-records-form" action="showApartment.php" method="POST">
...
<p><br></p>
<hr>
<h1>Show All records for All Apartments:</h1>

<form name="show-all-records-form" action="showAllApartments.php" method="POST">

      <button type="button" class="btn btn-primary" onClick="document.forms['show-all-records-form'].submit();">
